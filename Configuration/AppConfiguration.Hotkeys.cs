...
namespace EliteDataRelay.Configuration
{
    public static partial class AppConfiguration
    {
        ...
        public static Keys ShowOverlayHotkey { get; set; } = Keys.Control | Keys.Shift | Keys.F11;
        public static Keys HideOverlayHotkey { get; set; } = Keys.Control | Keys.Shift | Keys.F12;
    }
}
